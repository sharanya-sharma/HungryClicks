...
<html>
  <head>
    <title> Manager SignUp | HungryClicks </title>
  ...
  <body>
    ...
    <div class="container">
      <div class="panel-body">
        <form role="form" action="manager_registered_success.php" method="POST" class="form">
          <div class="panel-heading"> Manager! <br> Create Account </div>
          <div class="row">
          ...
          <label style="margin-left: 5px;"><a href="managerlogin.php" class="btn-primary">Have an account? Login.</a></label>
        </form>
      </div>  
    </div>
    <script>
