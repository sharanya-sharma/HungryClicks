<html>
<head>
    <title> Guest Signup | HungryClicks </title>
  ...
  <body>
    ...
    <div class="container">
      <div class="panel-body">          
        <form role="form" action="customer_registered_success.php" method="POST" class="form">
          <div class="panel-heading"> User! <br> Create Account </div>
          <div class="row">
          ...
          <label style="margin-left: 5px;"><a href="customerlogin.php" class="btn-primary">Have an account? Login.</a></label>
        </form>
      </div>
    </div>
